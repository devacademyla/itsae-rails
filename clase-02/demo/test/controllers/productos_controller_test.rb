...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { descripcion: @producto.descripcion, precio: @producto.precio, titulo: @producto.titulo }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { descripcion: @producto.descripcion, precio: @producto.precio, titulo: @producto.titulo }
    assert_redirected_to producto_path(assigns(:producto))
  end
